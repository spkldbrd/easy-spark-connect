...
import willHero from "@/assets/will-hero-light.jpg";
...
function Home3Page() {
  return (
    <SiteShell overDark>
      {/* HERO — lighter charcoal, warm halo behind portrait */}
      <section className="relative -mt-[72px] overflow-hidden bg-[#0e0f12] text-white">
        <img
          src={willHero}
        ...
        />
        {/* Softer left fade — darker than portrait but not pure black */}
        <div
          className="absolute inset-0 bg-gradient-to-r from-[#0e0f12] via-[#0e0f12]/85 to-transparent"
          aria-hidden
        />
        <div
          className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-[#0e0f12] via-[#0e0f12]/40 to-transparent"
          aria-hidden
        />

        <div className="relative mx-auto flex min-h-[92vh] max-w-7xl flex-col justify-end px-6 pb-24 pt-40">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.06] px-3.5 py-1.5 text-xs font-medium text-white/85 backdrop-blur">
          ...
          <div className="mt-24 flex flex-wrap items-end justify-between gap-6 border-t border-white/10 pt-6 text-xs uppercase tracking-[0.2em] text-white/45">
      ...
      {/* CTA */}
      <section className="relative overflow-hidden bg-[#0e0f12] py-32 text-white">
        <img
          src={willHero}
          alt=""
          width={1920}
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0e0f12]/85 via-[#0e0f12]/65 to-[#0e0f12]" />
