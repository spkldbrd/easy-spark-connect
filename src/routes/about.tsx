...
export const Route = createFileRoute("/about")({
  head: () =>
    buildSeo({
      title: "About | Digital Solution — SLO County IT Since 2015",
      description:
        "SLO County's trusted IT partner since 2015. Founded by an engineer with 30 years of Central Coast IT experience. Local team, no call centers, no surprises.",
      path: "/about",
      jsonLd: [
        {
          "@context": "https://schema.org",
          "@type": "AboutPage",
          url: "https://digitalsolution.com/about",
          mainEntity: {
            "@type": "LocalBusiness",
...
const team = [
  {
    ...
    bio: "Will has been doing IT on the Central Coast since 1995. He founded Digital Solution in 2015 to bring that experience to local businesses. A decade later, he still picks up the phone himself.",
  },
  {
